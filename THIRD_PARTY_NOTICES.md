...
- [b0o/ATVVoice](https://github.com/b0o/ATVVoice), MIT License, Copyright (c) 2026 Maddison Cohodas.
- [Infineon BLE HID Remote reference implementation](https://github.com/Infineon/mtb-example-btsdk-hid-ble-remote).
