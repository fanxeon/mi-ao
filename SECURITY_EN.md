...
- Physical-button mode takes over ten keys: D-pad, Center, Back, HOME, TV, Power, and Voice. Exact-device HID `No Event` prevents their native side effects; Menu and Volume Up/Down are never overridden. Event correlation remains a secondary defense. Use `--no-buttons` during sensitive editing.
